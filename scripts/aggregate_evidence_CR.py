#!/usr/bin/env python3
"""Aggregate evidence for the Code Review (CR) protocol."""
...
PROTOCOL_ID = "CR"
PROTOCOL_TITLE = "Code Review Validation"
VALIDATOR_COMMANDS: List[Dict[str, object]] = [
    {
        "name": "gate_standards",
        "script": "scripts/validate_gate_CR_standards.py",
        "args": ["--issues", ".artifacts/review-code/design-issues.json"],
    },
    {
        "name": "gate_tests",
        "script": "scripts/validate_gate_CR_tests.py",
        "args": ["--report", ".artifacts/review-code/test-validation-report.json"],
    },
    {
        "name": "gate_feedback",
        "script": "scripts/validate_gate_CR_feedback.py",
        "args": ["--log", ".artifacts/review-code/feedback-log.csv"],
    },
]
REFERENCE_SCRIPTS = [
    "scripts/validate_prerequisites_CR.py",
...
EXPECTED_ARTIFACTS = [
    {
        "path": ".artifacts/review-code/context-checklist.json",
        "description": "Scope alignment readiness checklist",
    },
    {
        "path": ".artifacts/review-code/change-impact.md",
        "description": "Change impact summary and affected modules",
    },
    {
        "path": ".artifacts/review-code/design-issues.json",
        "description": "Design and standards findings",
    },
    {
        "path": ".artifacts/review-code/test-validation-report.json",
        "description": "Automated test and coverage validation",
    },
    {
        "path": ".artifacts/review-code/feedback-log.csv",
        "description": "Feedback resolution log",
    },
    {
        "path": ".artifacts/review-code/decision-record.md",
        "description": "Final review decision record",
    },
]
...
def parse_args(argv: List[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Aggregate Code Review evidence")
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(".artifacts/review-code"),
